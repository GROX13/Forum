...
public class HandlePosts extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		// final String path =
		// "C:\\Users\\Anna.Anna-ой\\Workspace\\Forum_Website\\WebContent\\Images\\UploadedFiles";
		...
		try {
			if (adm != null)
				adm.WritePost(postThemeID, postText,
						new Date(System.currentTimeMillis()), files);
			if (usr != null)
				usr.WritePost(postThemeID, postText,
						new Date(System.currentTimeMillis()), files);

		} catch (SQLException e) {
			e.printStackTrace();
		}
		request.getRequestDispatcher("Posts.jsp?id=" + postThemeID).forward(
				request, response);
